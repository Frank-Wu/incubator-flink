...
package org.apache.flink.runtime.blobservice;
...
abstract class AbstractBaseImpl {
	 ...
	 */
	abstract InputStream get(final BlobKey key) throws IOException, FileNotFoundException;
	 ...
	 *         throw if an I/O error occurs while retrieving the data
	 */
	abstract URL getURL(final BlobKey key) throws IOException, FileNotFoundException;
