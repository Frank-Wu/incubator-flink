...
public class SqlitePerformanceTest {
	...
	public void runTest(SqliteState state){
		long startTime, endTime;
		double elapsedSeconds;
		state.executeUpdate("create table mykeyvalue(mykey varchar("+String.valueOf(stringLength)+"), myvalue int)");
		//insert
	...
	public void diskPerformanceTest(){
		System.out.println("============disk performance test==========");
	...
	public void memoryPerformanceTest(){
		System.out.println("============memory performance test==========");
		SqliteState state=new SqliteState("mydata", true);
		runTest(state);
	}
}
